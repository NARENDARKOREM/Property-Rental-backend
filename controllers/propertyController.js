    ...
    const formattedProperties = await Promise.all(
      properties.map(async (property) => {
        ...
        if (
          ...
          formattedStandardRules = `checkIn: ${property.standard_rules.checkIn || "N/A"}, checkOut: ${property.standard_rules.checkOut || "N/A"}, smokingAllowed: ${property.standard_rules.smokingAllowed !== undefined
